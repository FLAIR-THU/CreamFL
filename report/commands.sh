...
git pull && python src/vqa.py --name vqa_cw_0c50k --vqa_cat_weight count --server_lr 1e-5 --pretrained_model vqa_0c50k_best_1024_vqa.pt --seed 0 --feature_dim 1024 --pub_data_num 50000 --disable_distill --client_num_per_round 0 --num_img_clients 0 --num_txt_clients 0 --num_mm_clients 0 --comm_rounds 100
